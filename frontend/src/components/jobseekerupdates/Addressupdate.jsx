                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div className="flex flex-col gap-2 mb-4 w-80">
                            ...
                            <select defaultValue={user?.address?.housetype || "Select"}
                                ...
                                onChange={changeEventHandler}
                                required
                                        onInvalid={(e) => e.target.setCustomValidity("Enter your House Type")}
                        ...
                        <div className='grid gap-4 py-4'>
                            <div className='grid grid-cols-4 items-center gap-4'>
                                ...
                                <Input
                                    ...
                                    className="col-span-3"
                                    required
                                    onInvalid={(e) => e.target.setCustomValidity("Enter your House Address")}
                                    onInput={(e) => e.target.setCustomValidity("")}
                                />
                            </div>
                            ...
                            <div className='grid grid-cols-4 items-center gap-4'>
                                ...
                                <Input
                                    ...
                                    className="col-span-3"
                                    required
                                    onInvalid={(e) => e.target.setCustomValidity("Enter your Street")}
                                    onInput={(e) => e.target.setCustomValidity("")}
                                />
                            </div>
                            <div className='grid grid-cols-4 items-center gap-4'>
                            ...
                            <div className='grid grid-cols-4 items-center gap-4'>
                                ...
                                <Input
                                    ...
                                    className="col-span-3"
                                    required
                                    onInvalid={(e) => e.target.setCustomValidity("Enter your city")}
                                    onInput={(e) => e.target.setCustomValidity("")}
                                />
                            </div>
                            <div className='grid grid-cols-4 items-center gap-4'>
                                ...
                                <Input
                                    ...
                                    className="col-span-3"
                                    required
                                    onInvalid={(e) => e.target.setCustomValidity("Enter your district")}
                                    onInput={(e) => e.target.setCustomValidity("")}
                                />
                            </div>
                            <div className='grid grid-cols-4 items-center gap-4'>
                                ...
                                <Input
                                    ...
                                    className="col-span-3"
                                    required
                                    onInvalid={(e) => e.target.setCustomValidity("Enter your pincode")}
                                    onInput={(e) => e.target.setCustomValidity("")}
                                />
                            </div>
