...
//             {/* <h2 className="text-xl font-bold">Jobs Info World</h2> */}
//             <h1 className='text-2xl font-bold text-[#9b9790]'>JobsInfo<span className='text-[#336659]'>World</span></h1>
